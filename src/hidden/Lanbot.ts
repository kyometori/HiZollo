...
export default class Lanbot extends HiddenCommand {
  ...
  private r1 = [
    '我才不是爛 bot', '嗚嗚', 'QAQ', '......', '你叫誰爛 bot 啊', 
    '是 JavaScript 爛，不是我', '你才比較爛吧', '是開發我的人爛'
  ];
  private r2 = [{ files: ['./src/pictures/badbot.jpg'] }];

  public execute(message: Message): boolean {
    return this.allTimeResponse(message, this.r1, this.r2);
  }
}