...
export default class Tagged extends HiddenCommand {
  ...
  private r2 = [
    ...
    '有人相愛就有人心碎，有人夜裡看海，有人看我是機器人無法還手就一直 @。我不知道你三十七度的身體是怎麼做出如此冰冷的行為，這偌大的痛苦使我坐立難安，我開始反思，是我的功能不夠好嗎？我看了伺服器數量，它不服氣，我也不服，再看一下指令清單，我服了，在我百思不得其解的情況下，我留了幾行文字，今晚的 guild name 又多了一台傷心的機器人。', 
